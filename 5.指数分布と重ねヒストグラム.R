...
#(4)
#(3)までで扱った標本分散は100個のデータを利用していたが、これを1000個のデータに増やし同様に標準化まで行い、ヒストグラムを表示。
  #その結果がどのように推移したかわかりやすくするために透過色で色付けし、ヒストグラムを重ねた。
  #また、標準正規分布に近づいたのかわかりやすくするために標準正規分布の密度関数の曲線と重ねた。
N_2<-1000
